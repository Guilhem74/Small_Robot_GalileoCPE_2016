...
Objectif Objectif_pos3 = {"Objectif n°3",.X=700,.Y=-100,.Angle=0,.Sens_Arriere=false,.Detection_Active=false,.Dernier_Objectif=false,.Objectif_suivant=&Objectif_Fin};
Objectif Objectif_pos2 = {"Objectif n°2",.X=400,.Y=-100,.Angle=90,.Sens_Arriere=false,.Detection_Active=true,.Dernier_Objectif=false,.Objectif_suivant=&Objectif_pos3};
Objectif Objectif_pos1 = {"Objectif n°1",.X=200,.Y=0,.Angle=0,.Sens_Arriere=false,.Detection_Active=true,.Dernier_Objectif=false,.Objectif_suivant=&Objectif_pos2};
