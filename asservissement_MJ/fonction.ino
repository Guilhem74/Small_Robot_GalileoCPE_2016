...
void print_debug()
{
  ...
  SerialDebug.print("E_moy ");
  SerialDebug.print(erreur_moyenne);
  SerialDebug.print("\tV_moy ");
  SerialDebug.print(vitesse_moyenne);
  SerialDebug.print("\tE_angle ");
  SerialDebug.print(erreur_angle);
  SerialDebug.print("\tV_angle ");
  SerialDebug.println(vitesse_angle);
  //
  //  SerialDebug.print("E_moy_F ");
  //  SerialDebug.print(erreur_moyenne_fuzzy);
  //  SerialDebug.print("\tV_moy_F ");
  //  SerialDebug.print(vitesse_moyenne_fuzzy);
  //  SerialDebug.print("\tE_angle_F ");
  //  SerialDebug.print(erreur_angle_fuzzy);
  //  SerialDebug.print("\tV_angle_F ");
  //  SerialDebug.println(vitesse_angle_fuzzy);
  ...
  //  SerialDebug.print("\tY\t");
  //  SerialDebug.println(g_actuelle.Y);

  //  if(DEBUG_VITESSE)
  //  {
  //  SerialDebug.print("vitesse_D: ");
  //  SerialDebug.print(vitesse_D);
  //  SerialDebug.print(" vitesse_G: ");
  //  SerialDebug.print(vitesse_G);
  //  SerialDebug.print(" vitesse_moyenne: ");
  //  SerialDebug.print(vitesse_moyenne);
  //  }
  if (DEBUG_ANGLE)
  {
    SerialDebug.print(" erreur_D: ");
    SerialDebug.print(erreur_D);
    SerialDebug.print(" erreur_G: ");
    SerialDebug.print(erreur_G);
    SerialDebug.print(" erreur_moyenne: ");
    SerialDebug.print(erreur_moyenne);
    SerialDebug.print(" angle: ");
    SerialDebug.print(g_actuelle.Angle);
    SerialDebug.print(" erreur_angle: ");
    SerialDebug.println(erreur_angle);
  }
...
void asservir()
{
  ...
  vitesse_angle = 1000 * (float)((g_actuelle.Angle - temp_angle) / (float)(top_millis - temp_millis));
  ...
  //SerialDebug.print("direct_speed\t");
  //SerialDebug.print(direct_speed);
  //SerialDebug.print("\tangle_speed\t");
  //SerialDebug.println(angle_speed);
...
void mise_a_jour_POS()
{
  ...
  Gmm = G * PI * DIAMETRE_ROUE / TICCODEUSE; //conversion tic2mm
  ...
  last_X = g_actuelle.X;
  last_Y = g_actuelle.Y;
  g_actuelle.X = g_actuelle.X + int(localX);
  g_actuelle.Y = g_actuelle.Y + int(localY);

  localX -= (int)(localX);
  localY -= (int)(localY);

  temp_angle = g_actuelle.Angle;
  ...
  g_actuelle.Angle = (angle_radian * 360 / (float)(2 * PI));
}
...
void calcul_erreur()
{
  ...
  erreur_angle_radian = atan2(g_consigne.Y - g_actuelle.Y, g_consigne.X - g_actuelle.X) - angle_radian - PI * g_marche_arriere; //angle entre le vecteur perpendiculaire à l'axe des roues et le vecteur pointant sur la destination
  ...
  {
    erreur_angle = g_consigne.Angle - g_actuelle.Angle; //erreur entre l'angle actuel et l'angle commandé
  ...
  int32_t dx = g_consigne.X - g_actuelle.X, dy = g_consigne.Y - g_actuelle.Y;
  erreur_moyenne = (float)sqrt(dx * dx + dy * dy) * (float)cos(erreur_angle_radian -PI*g_marche_arriere); // projection de la distance séparant de la cible sur le vecteur perpendicualire à l'axe des roues
...
void setRobotSpeed(float output, float angle_speed)
{
  ...
  float k_vitesse = g_vitesse / (float)10000; // inverser /
  float k_vitesse_angulaire = (g_vitesse / RAPPORT_LINEAIRE_ANGULAIRE) / (float)10000;
  speed_out_D = output * k_vitesse + angle_speed * k_vitesse_angulaire;
  speed_out_G = output * k_vitesse - angle_speed * k_vitesse_angulaire;


  //  SerialDebug.print(output,10);
  //  SerialDebug.print('\t');
  //  SerialDebug.println(angle_speed,10);
  ...
  if (speed_out_D > PWM_MAX)speed_out_D = PWM_MAX;
  if (speed_out_G > PWM_MAX)speed_out_G = PWM_MAX;
  ...
  {
    SerialDebug.print("Sortie_PWM_D: ");
    SerialDebug.print(speed_out_D);
    SerialDebug.print("Sortie_PWM_G: ");
    SerialDebug.println(speed_out_G);
    SerialDebug.print("Output:");
    SerialDebug.println(output);
    SerialDebug.print("Sens D: ");
    SerialDebug.println(sens_D);
    SerialDebug.print("Sens G: ");
    SerialDebug.println(sens_G);

    
    SerialDebug.print("Angle speed:");
   SerialDebug.println(angle_speed);
  }
